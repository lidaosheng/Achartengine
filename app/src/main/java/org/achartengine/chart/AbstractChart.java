...
//      canvas.drawRect(x+30,y+20,x + width,y + height - 15 - height/5,paint);
    }
  }
  ...
  protected int drawLegend(Canvas canvas, DefaultRenderer renderer, String[] titles, int left,
    ...
    if (renderer.isShowLegend()) {
      ...
      System.out.println("--------------------默认textsize12:"+renderer.getLegendTextSize());
      ...
      for (int i = 0; i < sLength; i++) {
        ...
        if (r.isShowLegendItem()) {
          ...
          if (!calculate) {
            System.out.println("(r,currentX,currentY,i,text,extraSize):"+"("+r+","+currentX+","+currentY+","+i+","+text+","+extraSize);
