...
import org.achartengine.chart.BoxChart;
...
public class ChartFactory {
  ...
  //--------------------
  public static final GraphicalView getBoxChartView(Context context,
                                                    BoxMultipleSeriesDataset dataset, XYMultipleSeriesRenderer renderer){
    BoxChart chart = new BoxChart(dataset,renderer);
    return  new GraphicalView(context,chart);
  }
  public static final Intent getBoxChartIntent(Context context, BoxMultipleSeriesDataset dataset,
